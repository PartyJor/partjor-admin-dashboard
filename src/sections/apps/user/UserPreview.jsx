...
export default function UserPreview({ User, open, onClose, editUser }) {
...
UserPreview.propTypes = { User: PropTypes.any, open: PropTypes.bool, onClose: PropTypes.func, editUser: PropTypes.func };
